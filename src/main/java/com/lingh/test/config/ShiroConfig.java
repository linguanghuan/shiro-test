 ...
 * https://www.cnblogs.com/jpfss/p/8311317.html
 */
@Configuration
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        List<TResource> resourceList = resourceService.getAll();
        for (TResource tResource : resourceList) {
            if (StringUtils.isNotEmpty(tResource.getResourceUrl())) {
                String permission = "perms[" + tResource.getResourceUrl() + "]";
                filterChainDefinitionMap.put(tResource.getResourceUrl(), permission);
            }
        }
